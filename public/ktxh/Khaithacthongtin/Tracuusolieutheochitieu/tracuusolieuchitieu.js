$(document).ready(function() {
    ...
    axios.get('getlistchitieu').then(function(response) {
        ...
        if (data != null) {
            ...
            $('#khoichitieu').html('<option value=""></option>' + htmldonvihc);
        }
    })


    $('#timkiem').click(function() {
        loadsolieutheochitieu();
    });

    function loadsolieutheochitieu() {
        ...
        let khoichitieu = $('#khoichitieu').val();


        axios.post('loadsolieutheochitieu', { tinh: tinh, huyen: huyen, xa: xa, donvithuthap: donvithuthap, solieucuaky: solieucuaky, solieucuanam: solieucuanam, khoichitieu: khoichitieu }).then(function(response) {
