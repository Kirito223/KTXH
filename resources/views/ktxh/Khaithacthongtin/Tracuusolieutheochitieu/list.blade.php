@extends('master')
@section('title','Tra cứu số liệu theo chỉ tiêu')
@section('content')
	...
	<div class="col-md-12">
		<div class="widget">
			<header class="widget-header">
				<h5 class="widget-title">Tra cứu số liệu theo chỉ tiêu</h5>
			</header>
			...
			<div class="widget-body">
				<div class="row">
					...
					<div class="form-group row" style="margin-bottom: 10px">
						<h5 class="col-sm-3 col-form-label">Số liệu của năm : </h5>
					...
					<div class="form-group row" style="margin-bottom: 10px">
						<h5 class="col-sm-3 col-form-label">Chọn khối chỉ tiêu : </h5>
						<div class="col-sm-9">
							<div class="row">
								<div class="col-md-4">
									<select type="text" id="khoichitieu" class="form-control"></select>
								</div>
							</div>
						</div>
					</div>
...
<div id="sosanhtheochitieu" class="modal fade in" tabindex="-1" role="dialog">
...
<script type="text/javascript" src="ktxh/Khaithacthongtin/Tracuusolieutheochitieu/tracuusolieuchitieu.js">
	@endsection