    ...
    <div class="ibox ">
      <div class="ibox-title">
        <div class="row">
          ...
          <div class="col-lg-2">
            <button type="button" class="btn btn-w-m btn-success" data-toggle="modal" id="adddonvi" style="float: right;">Thêm mới</button>
          </div>
        </div>
      ...
      <div class="ibox-content">
        <div class="table-responsive">
          <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4">
            <table class="table table-striped table-bordered table-hover dataTables-example dataTable" id="table-donvi" aria-describedby="DataTables_Table_0_info" role="grid">
              <thead>
               <tr>
...
<div class="modal inmodal fade " id="modal-themdonvi" tabindex="-1" role="dialog" style="display: none;" aria-hidden="true">
