...
//route huy
//quản lý chỉ tiêu
Route::get('listchitieu', 'Quanlydanhmuc\Quanlychitieu\Chitieu@viewchitieu')->middleware('auth:taikhoan'); //->middleware('auth:taikhoan', 'checkpermission:super-admin');
...
//danh sách biểu mẫu
Route::get('listdanhsachbieumau/{id}', 'Khaithacthongtin\Danhsachbieumau\Danhsachbieumau@viewdanhsachbieumau')->middleware('auth:taikhoan');
...
Route::post('loaddubaosolieu', 'Khaithacthongtin\Dubaosolieu\Dubaosolieu@loaddubaosolieu');
Route::get('getlistchitieudubaosl', 'Khaithacthongtin\Dubaosolieu\Dubaosolieu@getlistchitieudubaosl');
...
Route::get('danhsachbieumau', 'quanlybieumau\NhaplieusolieuController@danhsachbieumau')->middleware('auth:taikhoan');
Route::get('danhsachbieumaubaocao', 'quanlybieumau\NhaplieusolieuController@danhsachbieumaubaocao')->middleware('auth:taikhoan');
...
Route::get('/thongbao/{id}/getThongbaoSentDetails', 'tbl_thongbaoController@getThongbaoSentDetails');
